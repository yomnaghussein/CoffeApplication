plugins {
    ...
    id(libs.plugins.kotlinParclable.get().pluginId)
}

android {
    namespace = "com.example.coffeapplication"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.coffeapplication"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation(libs.kotlinSerializedJson)
